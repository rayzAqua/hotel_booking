...
import { createBooking, deleteBooking, getBooking, getUserBookings, getAllBookings } from "../controllers/book_controller.js";
...
router.get("/all/:userid", verifyUser, getUserBookings);
